...
<CrossCourseRef
  ...
  lessonSlug="01-architecture-internals/04-dag-scheduler"
  label="DAG Scheduler — устройство и stages"
  preview="Глубокий разбор DAG Scheduler: как Spark строит execution plan, разбивает на stages, зачем shuffle boundary."
/>
...
<CrossCourseRef
  courseId="spark-course"
  lessonSlug="01-architecture-internals/06-shuffle-deep-dive"
  label="Shuffle в Spark — глубокое погружение"
  preview="Внутренности shuffle: sort-based vs hash-based, push-based shuffle (SPIP), внешний shuffle service, shuffle file format."
/>

<CrossCourseRef
  courseId="spark-course"
  lessonSlug="04-performance-tuning/01-shuffle-optimization"
  label="Оптимизация shuffle"
  preview="Практические техники: увеличение partitions, broadcast joins, salting для skew, репартиционирование перед join."
/>
